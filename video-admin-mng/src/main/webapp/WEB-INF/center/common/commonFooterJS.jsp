...
<!-- 想要正常显示头像，需要同时启动小程序对应的springboot的api服务 -->
...
<%--<input type="hidden" id="bgmServer" name="bgmServer" value="<%= strTmp %>:${pageContext.request.serverPort}${pageContext.request.contextPath}"/>--%>
<input type="hidden" id="bgmServer" name="bgmServer" value="<%=request.getContextPath() %>"/>
<!-- <input type="hidden" id="apiServer" name="apiServer" value="http://dsp.com/video-mini-api"/> -->
