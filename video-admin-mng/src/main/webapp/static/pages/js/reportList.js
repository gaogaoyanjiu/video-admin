            ...
            colModel: [  
                ...
                { name: '', index: '', width: 20, sortable: false, hidden: false,
                	formatter:function(cellvalue, options, rowObject) {
                        ...
                        button += '<button class="btn btn-outline red" id="" onclick=delVideo("' + rowObject.dealVideoId + '") style="padding: 1px 3px 1px 3px;">删除视频</button>';
			    		return button;
			    	}
			    }/*,
                { name: '', index: '', width: 20, sortable: false, hidden: false,
                    formatter:function(cellvalue, options, rowObject) {
                        var button = '<button class="btn btn-outline red" id="" onclick=delVideo("' + rowObject.dealVideoId + '") style="padding: 1px 3px 1px 3px;">删除视频</button>';
                        return button;
                    }
                }*/
            ],  
